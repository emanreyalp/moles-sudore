...
class ActivitiesTest < ApplicationSystemTestCase
  ...
  test "creating a Activity" do
    ...
    fill_in "After weight", with: @activity.after_weight
    fill_in "After weight with water", with: @activity.after_weight_with_water
    fill_in "Before weight", with: @activity.before_weight
    fill_in "Before weight with water", with: @activity.before_weight_with_water
